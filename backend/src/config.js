...
const namePrefix = "Bones Unburied";
const description = "Revive Jack BONES Jones";
...
const PUBLIC_MINT_START_DATE = "2023-02-06T11:30:48+00:00"; // This is required. Eg: 2022-02-08T11:30:48+00:00

// OPTIONAL CONTRACT DETAILS THAT CAN BE UPDATED LATER.
const PRESALE_MINT_START_DATE = "2022-12-20T05:00:48+00:00";
const ROYALTY_SHARE = 1000; // Percentage of the token price that goes to the royalty address. 100 bps = 1%
const ROYALTY_ADDRESS = "0x5344102f53EA74a915A0D9a438D6D5cE5c918CDB"; // Address that will receive the royalty
const BASE_URI = null; // only update if you want to manually set the base uri
const PREREVEAL_TOKEN_URI = null; // only update if you want to manually set the prereveal token uri
const PRESALE_WHITELISTED_ADDRESSES = ["0x5344102f53EA74a915A0D9a438D6D5cE5c918CDB"]; // only update if you want to manually set the whitelisted addresses
